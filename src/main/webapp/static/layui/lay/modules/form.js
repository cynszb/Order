            ...
            select: function(){
                var TIPS = '请选择', CLASS = 'layui-form-select', TITLE = 'layui-select-title'
                    ...
                    var showDown = function(){
                        ...
                        $('.tree-posi').next('.ztree').removeClass('tree-anim-upbit');
                            ...
                            , '<div class="' + TITLE + '"><input type="text" class="layui-input" placeholder="' + placeholder + '"><div class="layui-input multiSelect" >' + function(){
                                ...
                                if(value != null && value != undefined && value.length != 0){
                                    for(var aList = 0;aList<value.length;aList++){
                                        if(value[aList]){
                                        	/*console.log(4+'---'+select[value[aList]].text);*/
                                            aLists.push("<a href='javascript:;'><span>"+$(".sysRoleSelects option[value='"+value[aList]+"']").text()+"</span><i></i></a>")
                                        }
                                    }
                                }
                                return aLists.join('');
